...
import (
	...
	"github.com/pinger-v3/internals/pinger"
)
...
func main() {
	...
	flag.StringVar(&timeoutStr, "timeout", "1200ms", "pre-request timeout (e.g 8000ms, 2s)")
	flag.IntVar(&concurrency, "concurrency", 8, "max in-fligth requests")
	flag.StringVar(&writeCSVPath, "cvs", "", "optional path write results csv")
